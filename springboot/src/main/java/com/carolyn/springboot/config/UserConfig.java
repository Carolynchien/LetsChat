        ...
        return args ->{
            ...
            "https://images.unsplash.com/photo-1603570388466-eb4fe5617f0d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80","hey there", "marketing analysis");
                   ...
                   Appuser alex = new Appuser(
                    ...
                    ,"https://images.unsplash.com/photo-1526772662000-3f88f10405ff?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1674&q=80","hey there", "farmer");
                    Appuser jack = new Appuser(
                        "Jack",
                        "Smith",
                        "jack.smith@gmail.com",passwordEncoder.encode("abc1234"),
                        LocalDate.of(1991, Month.APRIL,22),0, "male","femal"
                        ,"https://images.unsplash.com/photo-1581803118522-7b72a50f7e9f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fG1hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60","hey there", "Science");
            ...
            repository.saveAll(List.of(mariam,alex, jack, anna,amy));
        };
